...
- AWS cloud architecture (VPC, RDS, S3, CloudFront, WAF, NAT Gateway, Elastic Beanstalk, etc.)
- Building CI/CD pipelines using CodePipeline & CodeBuild
- Designing systems following AWS Well-Architected Framework
...
- Consider adding more AWS-focused workshops or hands-on labs.
